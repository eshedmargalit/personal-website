            ...
            <div className={styles.newsItem}>
              <div className={styles.newsContent}>
                <div className={styles.newsText}>
                  I gave a talk at a&nbsp;
                  <SubtleLink
                    href="https://www.sitcancer.org/2025/home"
                    external={true}
                  >
                    SITC
                  </SubtleLink>
                ...
                <div className={styles.newsDate}>November 2025</div>
              </div>
              <ClickableImage
                src="/news/sitc_screenshot.png"
                alt="Screenshot of presentation at SITC 2025"
                url="https://www.sitcancer.org/2025/schedule/sitc25-preconference#workshop"
                width={600}
                height={400}
                className={styles.newsImage}
                isDark
